...
•	Метод doubleValues должен удваивать элементы списка по принципу "альфа", "бета", "гамма" ->
...
public class ArrayList2DoubleTheWords {
    public static void main(String[] args) throws Exception {
        ...
        for (int i = 0; i < 3; i++) {
            ...
            list.add(0, s); // Считай 10 строк с клавиатуры и добавь их в список.
        }
